...
use Server\Library\Sirius\Validation\Rule\Callback as CallbackRule;
...
class RuleFactory
{
    ...
    {
        if (is_subclass_of($class, '\Server\Library\Sirius\Validation\Rule\AbstractRule')) {
    ...
    protected function construcRuleByNameAndOptions($name, $options)
    {
        if (is_callable($name)) {
            ...
            if (class_exists('\Server\Library\Sirius\Validation\Rule\\' . $name, false)) {
                $name = '\Server\Library\Sirius\Validation\Rule\\' . $name;
            }
            // at this point we should have a class that can be instanciated
            if (class_exists($name) && is_subclass_of($name, '\Server\Library\Sirius\Validation\Rule\AbstractRule')) {
