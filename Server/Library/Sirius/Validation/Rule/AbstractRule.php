<?php
namespace Server\Library\Sirius\Validation\Rule;

use Server\Library\Sirius\Validation\DataWrapper\ArrayWrapper;
use Server\Library\Sirius\Validation\DataWrapper\WrapperInterface;
use Server\Library\Sirius\Validation\ErrorMessage;
...
abstract class AbstractRule
{
     ...
     * @var \Server\Library\Sirius\Validation\DataWrapper\WrapperInterface
     */
    protected $context;
     ...
     * @param mixed $value
     *
     * @return \Server\Library\Sirius\Validation\Rule\AbstractRule
     */
    ...
    public function setContext($context = null)
    {
        ...
        if ( ! is_object($context) || ! $context instanceof WrapperInterface) {
            throw new \InvalidArgumentException(
                'Validator context must be either an array or an instance of Server\Library\Sirius\Validator\DataWrapper\WrapperInterface'
            );
        }
     ...
     *
     * @return NULL|\Server\Library\Sirius\Validation\ErrorMessage
     */
