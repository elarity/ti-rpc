<?php
namespace Server\Library\Sirius\Validation;

use Server\Library\Sirius\Validation\ValidatorInterface;
...
class Validator implements ValidatorInterface
{
    ...
    /**
     * @var \Server\Library\Sirius\Validation\RuleFactory
     */
     ...
     *
     * @return \Server\Library\Sirius\Validation\RuleFactory
     */
     ...
     *
     * @return \Server\Library\Sirius\Validation\Rule\AbstractValidator
     */
    ...
    public function remove($selector, $name = true, $options = null)
    {
        ...
        /* @var $collection \Server\Library\Sirius\Validation\ValueValidator */
     ...
     * @param mixed $data
     *
     * @return \Server\Library\Sirius\Validation\DataWrapper\WrapperInterface
     */
    ...
    public function validate($data = null)
    {
        ...
        foreach ($this->rules as $selector => $valueValidator) {
            foreach ($this->getDataWrapper()->getItemsBySelector($selector) as $valueIdentifier => $value) {
                /* @var $valueValidator \Server\Library\Sirius\Validation\ValueValidator */
