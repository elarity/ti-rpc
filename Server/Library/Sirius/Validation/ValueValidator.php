...
use Server\Library\Sirius\Validation\Rule\AbstractRule;
...
class ValueValidator
{
     ...
     *
     * @var \Server\Library\Sirius\Validation\ErrorMessage
     */
     ...
     *
     * @var \Server\Library\Sirius\Validation\RuleCollection
     */
    protected $rules;
    ...
    public function validate($value, $valueIdentifier = null, DataWrapper\WrapperInterface $context = null)
    {
        ...
        /* @var $rule \Server\Library\Sirius\Validation\Rule\AbstractValidator */
        foreach ($this->rules as $rule) {
