...
namespace System\Library\ElasticSearch;
...
class Client {
    ...
    const DEFAULT_SERVER = '172.16.0.50:9200';
    ...
    protected static $_protocols = array(
        'http' => 'System\\Library\\ElasticSearch\\Transport\\HTTP',
        'memcached' => 'System\\Library\\ElasticSearch\\Transport\\Memcached',
    );
