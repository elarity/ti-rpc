...
namespace System\Library\Valitron;
...
class Validator
{
     ...
     * @var string
     */
    protected static $_langDir = ROOT.'System'.DS.'Library'.DS.'Valitron'.DS.'lang';
    ...
    public function setData( $data = array(), $fields = array() ) {
        $this->reset();
        $this->_fields = !empty($fields) ? array_intersect_key($data, array_flip($fields)) : $data;
        //$this->_errors = array();
    }
    ...
    public function errors($field = null)
    {
        ...
        $return_error = $this->_errors;
        $temp = array_shift( $return_error );
        $temp = isset( $temp[ 0 ] ) ? array_shift( $temp ) : $this->_errors ;
        return $temp;
        //return $this->_errors;
    }
